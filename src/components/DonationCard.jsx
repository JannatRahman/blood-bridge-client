    ...
    <div className="group w-full max-w-sm mx-auto bg-white rounded-3xl border border-gray-100 shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1 overflow-hidden">
      ...
      <div className="p-5 sm:p-6 bg-gradient-to-br from-rose-50 via-white to-red-50">
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-rose-600 text-white font-bold text-lg sm:text-xl shadow-sm">
            <Heart size={18} />
        ...
        <div className="mt-5 pt-5 space-y-3">
          ...
          <div className="flex items-center gap-3 text-sm text-gray-700">
            <Person size={16} className="text-rose-600 shrink-0" />
      ...
      <div className="p-4 sm:p-5 border-t border-gray-100">
        ...
        duration-300 group-hover:border-rose-200">
          ...
          <div className="w-10 h-10 rounded-xl  shadow-sm flex items-center bg-rose-100 cursor-pointer justify-center group-hover:bg-rose-600 group-hover:text-white transition-all duration-300">
            <ArrowRight size={18} />
          </div>
        </button>
        </Link>
