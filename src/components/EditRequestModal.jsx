...
const EditRequestModal = ({ isModalOpen, setIsModalOpen, editingRequest }) => {
  ...
  const onSubmit = async (data) => {
    // const result = await updateRequest(data, editingRequest?._id);
                ...
                <div className="grid grid-cols-1 gap-4 w-full">
                  <div className="w-full">
                    ...
                    <select
                      ...
                      className="w-full bg-slate-900/50 border border-white/10 text-white hover:border-pink-500/50 focus:border-pink-500 p-3 rounded-xl mt-1 outline-none"
                    >
                    ...
                    {errors.districts && (
                      <p className="text-red-500 text-xs mt-1">{errors.districts.message}</p>
                    )}
                  </div>
                </div>
