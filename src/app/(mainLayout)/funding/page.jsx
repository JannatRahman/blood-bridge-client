...
// Initialize Stripe outside of the component render to avoid re-creating the object.
// const stripePromise = loadStripe(process.env.NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY || "pk_test_mock");

const initialFunds = [
  { id: 1, name: "Alex Johnson", amount: 150, date: "2026-06-20" },
  { id: 2, name: "Sarah Connor", amount: 500, date: "2026-06-18" },
  { id: 3, name: "Michael Scott", amount: 75, date: "2026-06-15" },
  { id: 4, name: "Bruce Wayne", amount: 5000, date: "2026-06-10" },
];
    ...
    <div className="min-h-screen bg-gray-50 text-gray-800 p-6 md:p-12">
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-gray-200 pb-6">
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-2 bg-[#FF2E4E] hover:bg-[#E02440] text-white font-medium text-sm px-6 py-3 rounded-xl transition shadow-md shadow-red-200 active:scale-[0.98] cursor-pointer"
          >
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-xs">
          {/* Replicating the exact bright white modal container popup from your design */}
...
function CheckoutForm({ onSuccess, onCancel }) {
  ...
  // Phase 1: Matches your visual layout image exactly
  if (phase === "amount") {
    return (
      <form onSubmit={handleInitialSubmit} className="flex flex-col items-center">
        ...
        <button
          type="submit"
          className="w-full bg-[#FF2E4E] hover:bg-[#E02440] text-white font-bold text-base py-4 rounded-2xl transition shadow-md shadow-red-200 active:scale-[0.99] cursor-pointer mb-4"
        >
          Confirm & Pay
        </button>
  ...
  // Phase 2: Stripe information fields (also matching the light design theme)
  return (
